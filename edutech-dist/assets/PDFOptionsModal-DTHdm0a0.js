import{t as e}from"./GenericPDFOptionsModal-t744k5CL.js";import{Z as t,on as n,un as r}from"./index-CEf0UhSm.js";import{t as i}from"./sanitize-Bw6_Aa8o.js";import{r as a,t as o}from"./pdfBranding-DPK13G-_.js";function s(e,t=!1,n,r,a){let o=e.status===`approved`?`#10b981`:e.status===`rejected`?`#ef4444`:`#f59e0b`,s=e.status===`approved`?`APPROVED`:e.status===`rejected`?`REJECTED`:`PENDING`,c=e.status===`approved`?`অনুমোদিত`:e.status===`rejected`?`প্রত্যাখ্যাত`:`অপেক্ষমান`,l=a||`EduTech`;return`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
