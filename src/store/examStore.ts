...
const defaultRoutines: ExamRoutine[] = [
  { id: 'RT-001', examId: 'EXAM-001', classId: 'Class-1', sectionId: 'A', subjectId: 'SUB-001', date: '2025-06-15', startTime: '09:00', endTime: '12:00', roomNo: 'R-101', status: 'completed', createdAt: '2025-06-01' },
  { id: 'RT-002', examId: 'EXAM-001', classId: 'Class-1', sectionId: 'A', subjectId: 'SUB-002', date: '2025-06-16', startTime: '09:00', endTime: '12:00', roomNo: 'R-101', status: 'completed', createdAt: '2025-06-01' },
  { id: 'RT-003', examId: 'EXAM-001', classId: 'Class-1', sectionId: 'A', subjectId: 'SUB-003', date: '2025-06-17', startTime: '09:00', endTime: '11:00', roomNo: 'R-102', status: 'completed', createdAt: '2025-06-01' },
  { id: 'RT-004', examId: 'EXAM-001', classId: 'Class-1', sectionId: 'A', subjectId: 'SUB-004', date: '2025-06-18', startTime: '09:00', endTime: '12:00', roomNo: 'R-101', status: 'completed', createdAt: '2025-06-01' },
  { id: 'RT-005', examId: 'EXAM-001', classId: 'Class-1', sectionId: 'A', subjectId: 'SUB-005', date: '2025-06-19', startTime: '14:00', endTime: '16:00', roomNo: 'R-103', status: 'completed', createdAt: '2025-06-01' },
  { id: 'RT-006', examId: 'EXAM-001', classId: 'Class-2', sectionId: 'A', subjectId: 'SUB-001', date: '2025-06-20', startTime: '09:00', endTime: '12:00', roomNo: 'R-201', status: 'in-progress', createdAt: '2025-06-01' },
  { id: 'RT-007', examId: 'EXAM-002', classId: 'Class-1', sectionId: 'A', subjectId: 'SUB-001', date: '2025-11-10', startTime: '09:00', endTime: '12:00', roomNo: 'R-101', status: 'upcoming', createdAt: '2025-10-01' },
]
...
const defaultSeatPlans: ExamSeatPlan[] = [
  { id: 'SP-001', examId: 'EXAM-001', roomId: 'RM-001', studentId: 'STU-001', classId: 'Class-1', sectionId: 'A', seatNo: 1, roll: '001', assignedAt: '2025-06-10' },
  { id: 'SP-002', examId: 'EXAM-001', roomId: 'RM-001', studentId: 'STU-002', classId: 'Class-1', sectionId: 'A', seatNo: 2, roll: '002', assignedAt: '2025-06-10' },
  { id: 'SP-003', examId: 'EXAM-001', roomId: 'RM-001', studentId: 'STU-003', classId: 'Class-1', sectionId: 'A', seatNo: 3, roll: '003', assignedAt: '2025-06-10' },
  { id: 'SP-004', examId: 'EXAM-001', roomId: 'RM-002', studentId: 'STU-004', classId: 'Class-1', sectionId: 'B', seatNo: 1, roll: '001', assignedAt: '2025-06-10' },
  { id: 'SP-005', examId: 'EXAM-001', roomId: 'RM-002', studentId: 'STU-005', classId: 'Class-1', sectionId: 'B', seatNo: 2, roll: '002', assignedAt: '2025-06-10' },
]
...
const defaultOMRConfigs: OMRConfig[] = [
  { id: 'OMR-001', examId: 'EXAM-001', subjectId: 'SUB-001', totalQuestions: 50, correctMark: 2, negativeMark: 0.5, optionCount: 4, sheetFormat: 'A', createdAt: '2025-06-01' },
  { id: 'OMR-002', examId: 'EXAM-001', subjectId: 'SUB-002', totalQuestions: 40, correctMark: 2.5, negativeMark: 0.5, optionCount: 4, sheetFormat: 'B', createdAt: '2025-06-01' },
]

const defaultExtraMarks: ExtraMarkEntry[] = [
  { id: 'EM-001', examId: 'EXAM-001', studentId: 'STU-001', classId: 'Class-1', sectionId: 'A', type: 'attendance', marks: 8, maxMarks: 10, note: '80% attendance', createdAt: '2025-06-25' },
  { id: 'EM-002', examId: 'EXAM-001', studentId: 'STU-001', classId: 'Class-1', sectionId: 'A', type: 'discipline', marks: 9, maxMarks: 10, note: 'Excellent behavior', createdAt: '2025-06-25' },
  { id: 'EM-003', examId: 'EXAM-001', studentId: 'STU-001', classId: 'Class-1', sectionId: 'A', type: 'homework', marks: 18, maxMarks: 20, note: '90% completion', createdAt: '2025-06-25' },
  { id: 'EM-004', examId: 'EXAM-001', studentId: 'STU-002', classId: 'Class-1', sectionId: 'A', type: 'attendance', marks: 9, maxMarks: 10, note: '90% attendance', createdAt: '2025-06-25' },
  { id: 'EM-005', examId: 'EXAM-001', studentId: 'STU-002', classId: 'Class-1', sectionId: 'A', type: 'discipline', marks: 10, maxMarks: 10, note: 'Perfect conduct', createdAt: '2025-06-25' },
  { id: 'EM-006', examId: 'EXAM-001', studentId: 'STU-002', classId: 'Class-1', sectionId: 'A', type: 'homework', marks: 19, maxMarks: 20, note: '95% completion', createdAt: '2025-06-25' },
]

const defaultMarksheetConfigs: MarksheetConfig[] = [
  { id: 'MS-001', name: '1st Semester Marksheet', nameBn: '১ম সেমিস্টার মার্কশিট', examId: 'EXAM-001', sessionId: '2025-26', headSubjectId: 'SUB-003', workingDays: 120, schoolName: 'EduTech International School', schoolNameBn: 'এডুটেক ইন্টারন্যাশনাল স্কুল', schoolAddress: 'Dhaka, Bangladesh', logo: '', footer: 'This is a system-generated marksheet.', footerBn: 'এটি একটি সিস্টেম-জেনারেটেড মার্কশিট।', isPublished: false, createdAt: '2025-06-25' },
]

const defaultGeneralAbilities: GeneralAbilityConfig[] = [
  { id: 'GA-001', examId: 'EXAM-001', name: 'Creative Thinking', nameBn: 'সৃজনশীল চিন্তা', maxMarks: 10, description: 'Assess creative thinking ability' },
...
const defaultGradeScale: GradeScale[] = [
  { id: 'GS-001', name: 'Standard', nameBn: 'স্ট্যান্ডার্ড', grades: [
...
const defaultPromotions: StudentPromotion[] = [
  { id: 'PRM-001', examId: 'EXAM-001', studentId: 'STU-001', fromClass: 'Class-1', fromSection: 'A', toClass: 'Class-2', toSection: 'A', status: 'promoted', totalMarks: 500, obtainedMarks: 425, percentage: 85, grade: 'A+', promotedAt: '2025-06-30', promotedBy: 'Admin' },
  { id: 'PRM-002', examId: 'EXAM-001', studentId: 'STU-002', fromClass: 'Class-1', fromSection: 'A', toClass: 'Class-2', toSection: 'A', status: 'eligible', totalMarks: 500, obtainedMarks: 380, percentage: 76, grade: 'A', promotedAt: '', promotedBy: '' },
  { id: 'PRM-003', examId: 'EXAM-001', studentId: 'STU-003', fromClass: 'Class-1', fromSection: 'A', toClass: 'Class-2', toSection: 'A', status: 'not-eligible', totalMarks: 500, obtainedMarks: 155, percentage: 31, grade: 'F', promotedAt: '', promotedBy: '' },
]

const defaultCumulativeSheets: CumulativeMarksheet[] = [
  { id: 'CMS-001', name: 'Annual Cumulative', nameBn: 'বার্ষিক কিউমুলেটিভ', examIds: ['EXAM-001', 'EXAM-002'], sessionId: '2025-26', classId: 'Class-1', isPublished: false, createdAt: '2025-06-25' },
]

const defaultMarksEntryStatus: MarksEntryStatus[] = [
  { id: 'MES-001', examId: 'EXAM-001', classId: 'Class-1', sectionId: 'A', subjectId: 'SUB-001', teacherId: 'TCH-001', status: 'completed', totalStudents: 40, enteredCount: 40, lockedAt: '2025-06-20' },
  { id: 'MES-002', examId: 'EXAM-001', classId: 'Class-1', sectionId: 'A', subjectId: 'SUB-002', teacherId: 'TCH-002', status: 'completed', totalStudents: 40, enteredCount: 40, lockedAt: '2025-06-20' },
  { id: 'MES-003', examId: 'EXAM-001', classId: 'Class-1', sectionId: 'A', subjectId: 'SUB-003', teacherId: 'TCH-003', status: 'in-progress', totalStudents: 40, enteredCount: 28, lockedAt: null },
  { id: 'MES-004', examId: 'EXAM-001', classId: 'Class-1', sectionId: 'A', subjectId: 'SUB-004', teacherId: 'TCH-001', status: 'pending', totalStudents: 40, enteredCount: 0, lockedAt: null },
  { id: 'MES-005', examId: 'EXAM-001', classId: 'Class-2', sectionId: 'A', subjectId: 'SUB-001', teacherId: 'TCH-004', status: 'in-progress', totalStudents: 38, enteredCount: 15, lockedAt: null },
]
  ...
  persist(
    (set, get) => ({
      ...
      upsertSubjectMarkConfig: (config) => set(state => {
        const existing = state.subjectMarkConfigs.find(s => s.examId === config.examId && s.classId === config.classId && s.subjectId === config.subjectId)
        if (existing) {
      ...
      copyClassMarkConfig: (examId, fromClassId, toClassId) => set(state => {
      ...
      bulkAddRoutines: (routines) => set(state => ({
        routines: [...state.routines, ...routines.map((r, i) => ({ ...r, id: `RT-${Date.now()}-${i}`, createdAt: new Date().toISOString() }))]
      })),
      ...
      // ─── Seat Plans ───
      addSeatPlan: (plan) => set(state => ({
        seatPlans: [...state.seatPlans, { ...plan, id: `SP-${Date.now()}`, assignedAt: new Date().toISOString() }]
      })),
      removeSeatPlan: (id) => set(state => ({
        seatPlans: state.seatPlans.filter(sp => sp.id !== id)
      })),
      autoAssignSeats: (examId, classId, sectionId, studentIds, roomIds) => set(state => {
        ...
        for (const sid of studentIds) {
          ...
          newPlans.push({
            id: `SP-${Date.now()}-${sid}`,
            examId, roomId: room.id, studentId: sid, classId, sectionId,
            seatNo, roll: sid.split('-').pop() || String(seatNo),
            assignedAt: new Date().toISOString(),
          })
          seatNo++
          if (seatNo > (room?.capacity || 40)) { seatNo = 1; roomIdx++ }
        }
        return { seatPlans: [...existing, ...newPlans] }
      }),

      // ─── Invigilators ───
      addInvigilator: (inv) => set(state => ({
        invigilators: [...state.invigilators, { ...inv, id: `INV-${Date.now()}` }]
      })),
      removeInvigilator: (id) => set(state => ({
        invigilators: state.invigilators.filter(i => i.id !== id)
      })),

      // ─── OMR Config ───
      upsertOMRConfig: (config) => set(state => {
      ...
      unlockMarks: (examId, classId, sectionId, subjectId) => set(state => {
        const entry = state.marksEntryStatuses.find(m =>
          m.examId === examId && m.classId === classId && m.sectionId === sectionId && m.subjectId === subjectId
        )
        if (entry) {
