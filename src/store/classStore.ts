...
export const defaultThemeColorsDark: ThemeColors = {
  ...
  teal: '#818cf8',
  tealLight: 'rgba(129,140,248,0.1)',
  green: '#818cf8',
  greenLight: 'rgba(129,140,248,0.1)',
  red: '#f87171',
  redLight: 'rgba(248,113,113,0.1)',
  amber: '#818cf8',
  amberLight: 'rgba(129,140,248,0.1)',
  purple: '#818cf8',
  purpleLight: 'rgba(129,140,248,0.1)',
  bgPrimary: '#0f0f0f',
  bgSecondary: '#1a1a1a',
  bgTertiary: '#0a0a0a',
  surface: '#1a1a1a',
  ...
  cardYellow: 'rgba(129,140,248,0.08)',
  cardGreen: 'rgba(129,140,248,0.08)',
  cardPurple: 'rgba(129,140,248,0.08)',
}
