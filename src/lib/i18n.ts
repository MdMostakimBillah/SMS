export const translations = {
  bn: {
    ...
    nav_accounting_report: 'হিসাব রিপোর্ট',
    nav_library: 'লাইব্রেরি',
    nav_transport: 'পরিবহন',
    nav_hostel: 'হোস্টেল',
    nav_others_income: 'অন্যান্য আয়',
    nav_messages: 'বার্তা',
    ...
    nav_superadmin_back: 'সুপার অ্যাডমিনে ফিরুন',
    nav_settings: 'সেটিংস',
  ...
  en: {
    ...
    nav_accounting_report: 'Accounting Report',
    nav_library: 'Library',
    nav_transport: 'Transport',
    nav_hostel: 'Hostel',
    nav_others_income: 'Others Income',
    ...
    nav_reports: 'Reports',
    nav_superadmin: 'Super Admin',
    nav_superadmin_back: 'Back to Super Admin',
