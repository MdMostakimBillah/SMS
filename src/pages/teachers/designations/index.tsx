...
export default function DesignationsPage() {
  ...
  const input = "w-full px-[11px] py-[9px] rounded-lg border border-[var(--border)] bg-[var(--bg-secondary)] text-[var(--text-primary)] text-[13px] font-[inherit] outline-none"
          ...
          <table className="w-full border-collapse text-xs min-w-[500px]">
            <thead>
              <tr className="bg-[var(--bg-secondary)] border-b border-[var(--border)]">
                {[
                  ...
                  <th key={h.l} className="px-3 py-[10px] text-left text-[10px] font-semibold text-[var(--text-muted)] uppercase tracking-[0.4px] whitespace-nowrap"
            ...
            <tbody>
              {designations.length === 0
                ? <tr><td colSpan={5} className="p-10 text-center text-[var(--text-muted)]">
