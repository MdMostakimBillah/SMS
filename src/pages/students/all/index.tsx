...
export default function AllStudentsPage() {
  ...
  return (
    <div style={{ display:'flex', flexDirection:'column', height:'calc(100vh - 60px)' }}>
      ...
      {/* View modal */}
      {viewSt && (
        <div style={{ position:'fixed', top:0, left:0, right:0, height:'100dvh', background:'rgba(0,0,0,0.5)', zIndex:9999, display:'flex', alignItems:'flex-start', justifyContent:'flex-start', padding:'16px', overflowY:'auto' }}>
          <div className="modal-content" style={{ background:'var(--bg-primary)', borderRadius:'16px', maxWidth:'560px', width:'100%', maxHeight:'90vh', overflow:'hidden', display:'flex', flexDirection:'column', border:'1px solid var(--border)', boxShadow:'var(--shadow-lg)', margin:'0 auto' }}>
            <div style={{ padding:'14px 18px', borderBottom:'1px solid var(--border)', display:'flex', alignItems:'flex-start', justifyContent:'space-between', background:'var(--brand-light)' }}>
              ...
              <div style={{ display:'flex', gap:'8px', alignItems:'flex-start' }}>
                ...
                <button onClick={() => setViewSt(null)} style={{ width:'28px', height:'28px', borderRadius:'7px', background:'var(--bg-secondary)', border:'1px solid var(--border)', cursor:'pointer', display:'flex', alignItems:'flex-start', justifyContent:'flex-start' }}>
            ...
            <div style={{ padding:'12px 18px', borderTop:'1px solid var(--border)', display:'flex', gap:'8px', justifyContent:'flex-end', flexWrap:'wrap' }}>
              <button onClick={() => {
                ...
                style={{ display:'flex', alignItems:'flex-start', gap:'5px', padding:'8px 14px', borderRadius:'8px', background:'var(--red-light)', border:'1px solid var(--red)', color:'var(--red)', fontSize:'13px', fontWeight:500, cursor:'pointer', fontFamily:'inherit' }}>
              ...
              <button onClick={() => { navigate('/students/update', { state:{ studentId: viewSt.id } }); setViewSt(null) }}
                style={{ display:'flex', alignItems:'flex-start', gap:'5px', padding:'8px 14px', borderRadius:'8px', background:'var(--amber)', border:'none', color:'#fff', fontSize:'13px', fontWeight:500, cursor:'pointer', fontFamily:'inherit' }}>
      ...
      <div style={{ flexShrink:0 }}>
        ...
        <div style={{ display:'flex', gap:'8px', flexWrap:'wrap' }}>
          <button onClick={() => navigate('/students/update')}
            style={{ display:'flex', alignItems:'flex-start', gap:'5px', padding:'8px 14px', borderRadius:'9px', background:'var(--amber-light)', border:'1px solid var(--amber)', color:'var(--amber)', fontSize:'13px', cursor:'pointer', fontFamily:'inherit', fontWeight:500 }}>
            <Edit2 size={14} />{isBn?'আপডেট':'Update'}
          </button>
          <button onClick={() => navigate('/students/bulk-update')}
            style={{ display:'flex', alignItems:'flex-start', gap:'5px', padding:'8px 14px', borderRadius:'9px', background:'var(--green-light)', border:'1px solid var(--green)', color:'var(--green)', fontSize:'13px', cursor:'pointer', fontFamily:'inherit', fontWeight:500 }}>
      ...
      <div style={{ position:'sticky', top:0, zIndex:50, background:'var(--bg-primary)', paddingTop:'2px', paddingBottom:'4px' }}>
        ...
        {hasFilter && (
          <button onClick={clearFilters}
            style={{ display:'flex', alignItems:'flex-start', gap:'5px', padding:'4px 10px', borderRadius:'6px', background:'var(--red-light)', border:'1px solid var(--red)', color:'var(--red)', fontSize:'11px', cursor:'pointer', fontFamily:'inherit', marginTop:'8px' }}>
