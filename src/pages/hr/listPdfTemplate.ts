...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  th { background:${brand.brandColor}; color:#fff; padding:5px 5px; text-align:left; font-size:8px; font-weight:700; text-transform:uppercase; border:0.5px solid ${darkerBrand}; white-space:nowrap; }
