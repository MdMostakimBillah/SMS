...
import { getYouTubeId, getFacebookVideoId, platformColors, platformLabels, type OnlineClass } from '@/store/onlineStore'
...
function getEmbedUrl(url: string): string {
  ...
  if (fbId) return `https://www.facebook.com/plugins/video.php?href=${encodeURIComponent(`https://www.facebook.com/video/video.php?v=${fbId}`)}&show_text=false&width=560`
