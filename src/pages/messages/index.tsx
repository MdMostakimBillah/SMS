			...
			<div className="chat-shell card--premium">
				...
				<div className="chat-window">
					<div className="flex items-center gap-3 pb-3 border-b border-[var(--border-soft)] mb-3">
						...
						<div className="flex gap-2">
							<button className="border-none bg-transparent"><Phone size={16} /></button>
							<button className="border-none bg-transparent"><Video size={16} /></button>
						</div>
					</div>
					...
					<div className="pt-3 border-t border-[var(--border-soft)]">
						<div className="flex gap-2">
							<input placeholder="Type a message..." className="flex-1 px-3 py-2.5 rounded-xl border border-[var(--border-soft)] bg-[var(--card)]" />
