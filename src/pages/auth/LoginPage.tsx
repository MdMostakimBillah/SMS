  ...
  return (
    <div className="min-h-screen flex bg-[#0a0a0f]">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center">
        ...
        <div className="absolute inset-0" style={{ background: 'linear-gradient(160deg, #0a0a0f 0%, #0d0d14 40%, #0f0f18 70%, #0a0a0f 100%)' }} />
        ...
        <div className="relative z-10 text-center px-8">
          ...
          <h1 className="text-[2rem] font-bold text-white mb-3 tracking-tight">
            EduTech SMS
          </h1>
          <p className="text-[1rem] text-white/50 max-w-[280px] mx-auto leading-relaxed">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-[#0a0a0f]">
        <div className="w-full max-w-[22rem]">
          ...
          <div className="lg:hidden text-center mb-8">
            ...
            <h1 className="text-xl font-bold text-white">EduTech SMS</h1>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* Email */}
            <div>
              <label className="text-[0.75rem] font-medium text-white/50 mb-1.5 block">
                {isBn ? 'ইমেইল' : 'Email'}
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-11 pl-10 pr-4 rounded-xl border border-white/10 bg-white/5 text-[0.875rem] text-white placeholder:text-white/20 outline-none focus:border-[var(--brand)]/50 focus:bg-white/[0.07] transition-all"
                  required
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full h-11 pl-10 pr-11 rounded-xl border border-white/10 bg-white/5 text-[0.875rem] text-white placeholder:text-white/20 outline-none focus:border-[var(--brand)]/50 focus:bg-white/[0.07] transition-all"
                  required
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-white/30 hover:text-white/60 cursor-pointer bg-transparent border-none transition-colors"
                >
                ...
                {passwordValidation.map((rule) => (
                  <div key={rule.label} className="flex items-center gap-2">
                    <div className={`w-4 h-4 rounded-full flex items-center justify-center transition-colors ${
                      rule.met ? 'bg-[var(--green)]/20' : 'bg-white/5'
                    }`}>
                      {rule.met ? (
                    ...
                    <span className={`text-[0.6875rem] transition-colors ${
                      rule.met ? 'text-[var(--green)]' : 'text-white/30'
                    }`}>
          ...
          <div className="mt-8 text-center">
            <div className="flex items-center justify-center gap-2 text-[0.6875rem] text-white/20">
              <Lock size={11} />
